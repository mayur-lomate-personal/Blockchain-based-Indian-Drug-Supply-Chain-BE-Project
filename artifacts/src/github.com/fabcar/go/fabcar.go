...
type Medicine struct {
	...
	MedicineManufacturer  string `json:"MedicineManufacturer"`
...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	case "updateCurrentState":
		return s.updateCurrentState(APIstub, args)
	case "updateCurrentOwner":
		return s.updateCurrentOwner(APIstub, args)
	case "queryMedicine":
		return s.queryMedicine(APIstub, args)
	case "createMedicine":
...
func (s *SmartContract) updateCurrentState(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *SmartContract) updateCurrentOwner(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *SmartContract) queryMedicine(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *SmartContract) createMedicine(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var medicine = Medicine{MedicineName: args[1], MedicineManufacturer: args[2], ExpirationDate: args[3], SerialNo: args[4], BatchNo: args[5], CurrentOwner: args[6], CurrentState: args[7], GSTNo: args[8]}
	medicineAsBytes, _ := json.Marshal(medicine)
	APIstub.PutState(args[0], medicineAsBytes)
	return shim.Success(medicineAsBytes)
}
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	var medicine = Medicine{MedicineName: "hh", MedicineManufacturer: "cc", ExpirationDate: "44", SerialNo: "22", BatchNo: "66", CurrentOwner: "cc", CurrentState: "Go-Solapur", GSTNo: "1"}
	medicineAsBytes, _ := json.Marshal(medicine)
	APIstub.PutState("1", medicineAsBytes)
